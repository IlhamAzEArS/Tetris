...
class Program
{
    ...
    List<Debtor> debtors = new List<Debtor> {
        ...
        //string[] vs = { "A", "E", "I", "O", "U" };
        //List<Debtor> debtors1 = debtors.Where(t => t.FullName.StartsWith("A")).ToList();
        ...
        //List<Debtor> debtors2 = debtors.Where(t => t.Email.EndsWith("rhyta.com") || t.Email.EndsWith("rhyta.com")).ToList();
        //Console.WriteLine("===============");
        ...
        //}
        //Console.WriteLine("===============");
        //List<Debtor> debtors3 = debtors.Where(t => (2019 - (t.BirthDay.Year) > 26) && (2019 - (t.BirthDay.Year) < 36)).ToList();
        //foreach (var item in debtors3)
        //{
        //    Console.WriteLine(item);

        //}
        Console.WriteLine("===============");
        List<Debtor> debtors4 = debtors.Where(t => t.Debt > 5000).ToList();
        debtors4.ForEach(i => Console.WriteLine(i.ToString()));
        Console.WriteLine("===============");
        List<Debtor> debtors5 = debtors.Where(t => t.FullName.Length > 18 && t.Phone.Count() ).ToList();
        debtors5.ForEach(i => Console.WriteLine(i.ToString()));


        //foreach (var item in debtors4)
        //{
        //    Console.WriteLine(item);
